...
const DetalleProducto = lazy(()=> import('./ui/pages/Detalle'));
import NoEncontrada from './ui/pages/NoEncontrada';
import Layout from './ui/layout/layout';
import RutaProtegida from './ui/components/RutaProtegida';
import Pedidos from './ui/pages/Pedidos';
import SkeletonDetalle from './ui/components/SkeletonDetalle';
import Coleccion from './ui/pages/Coleccion';
import AgregarNuevoProducto from './ui/pages/AgregarNuevoProducto';
    ...
    <Routes>
      <Route element={<Layout/>}>
        ...
        <Route element={<RutaProtegida/>}>
          ...
          <Route path='/nuevoProducto' element={<AgregarNuevoProducto productos={productos}/>}></Route>
        </Route>

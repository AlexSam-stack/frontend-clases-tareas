...
interface ValorSesion {
    ...
    entrar : (usuario : string, clave : string, isRecordado:boolean) => Promise<void>;
    salir : () => void;
}
...
export function SesionProvider ({children} : {children : ReactNode}) {
    ...
    //entrar
    async function entrar(nombreUsuario : string, clave : string, isRecordado:boolean) {
        const conectado = await iniciarSesion(nombreUsuario, clave);
        guardarSesion(conectado,isRecordado);
